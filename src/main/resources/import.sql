...
INSERT INTO `users` VALUES (2,'Vanessa',NULL,NULL,'',NULL,'Ramirez','$2a$10$pLiT5n4R/wOZ8SyKgNvvOeRuMd07/m9QzguNQFJPfphWUB0ktQ2zS',83208113,'admin'),(3,'Juan',NULL,NULL,'',NULL,'Carlos','$2a$10$fpZ3pU63UnhsJcAPopsz1.hBzYFe5ptoCXcP4UXkqwv8MBwdHV6x6',7220853,'JUAK'),(4,'Marlon',NULL,NULL,'',NULL,'Perez','$2a$10$jOCme7X0UbijvrV6OvVbaer/ZYNbDSZozy/yF.xyG00NmBiofjon',7283113,'MP123');
INSERT INTO `users` VALUES (4,'Carlos',NULL,NULL,'',NULL,'Hernandez','$2a$10$pXSjZhKajePgUvQZplTkOuA6n4ee/wHaOF/UJWornHmRxhN3D0Cd6',71208113,'andres');
